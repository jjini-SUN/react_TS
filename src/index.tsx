...
const 초기값 : {count:number, user:string} = {count:0, user:'신정환'}

// createStore => createSlice
// createSlice 에는 name, initialState, reducers 만들어줘야 함
const countSlice = createSlice({
  ...
  reducers:{
    ...
    {
      state.count += action.payload  //action은 무조건.payload 붙여서 사용하기 
    },
    초기화(state)
    {
      state.count = 0
...
//제공할 리듀서 변수, 함수, state 를 import 할 수 있게 export
